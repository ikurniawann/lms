...
export default function ParentAttendance() {
  ...
  const statsCards = [
    { title: 'Kehadiran', value: '95.5%', icon: CheckCircle, color: 'green' },
    { title: 'Hadir', value: '57', icon: Calendar, color: 'blue' },
    { title: 'Sakit', value: '2', icon: Clock, color: 'yellow' },
    { title: 'Izin', value: '3', icon: AlertCircle, color: 'purple' },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      <aside className="fixed w-64 bg-white border-r">
        ...
        <nav className="p-4 space-y-1">
          ...
          <a href="/parent/attendance" className="block px-4 py-3 bg-blue-50 text-blue-700">Absensi</a>
      ...
      <div className="ml-64">
        ...
        <main className="p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Kelas {child.class} • Rekap Kehadiran</p>
          </div>
