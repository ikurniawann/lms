    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 lg:translate-x-0">
        ...
        <nav className="p-4 space-y-1">
          ...
          <a href="/parents" className="flex items-center space-x-3 px-4 py-3 bg-green-50 text-green-700 rounded-lg transition-all border border-green-200">
            <UserCheck className="w-5 h-5" />
            <span className="font-medium text-sm">Orang Tua</span>
          </a>
      ...
      <div className="lg:ml-64">
        ...
        <header className="h-16 bg-white border-b border-gray-200 sticky top-0 z-40">
          <div className="h-full px-4 sm:px-6 flex items-center justify-between">
            <h1 className="text-xl font-bold text-gray-900">Manajemen Orang Tua</h1>
          </div>
        </header>
