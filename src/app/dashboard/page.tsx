...
export default function DashboardAdmin() {
  ...
  const menuItems = [
    ...
    { icon: Users, label: 'Siswa', href: '/students', active: false },
    { icon: GraduationCap, label: 'Guru', href: '/teachers', active: false },
    { icon: UserCheck, label: 'Orang Tua', href: '/parents', active: false },
    { icon: School, label: 'Kelas', href: '/classes', active: false },
    { icon: FileText, label: 'Ujian', href: '/exams', active: false },
    { icon: Wallet, label: 'Keuangan', href: '/finance', active: false },
    { icon: CheckSquare, label: 'Absensi', href: '/attendance', active: false },
    { icon: Calendar, label: 'Cuti', href: '/leave', active: false },
    { icon: Award, label: 'Sertifikat', href: '/certificates', active: false },
    { icon: BookOpen, label: 'Perpustakaan', href: '/library', active: false },
    { icon: CreditCard, label: 'Akun', href: '/accounts', active: false },
    { icon: UserCog, label: 'HRM', href: '/hrm', active: false },
    { icon: Megaphone, label: 'Pengumuman', href: '/announcements', active: false },
    { icon: CalendarEvent, label: 'Acara', href: '/events', active: false },
    { icon: MessageSquare, label: 'Pesan', href: '/messages', active: false },
  ];
